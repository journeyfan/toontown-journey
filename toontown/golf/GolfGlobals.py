...
TrophyRequirements = {CoursesCompleted: (5, 20, 50),
 CoursesUnderPar: (1, 5, 20),
 HoleInOneShots: (1, 5, 10),
 EagleOrBetterShots: (1, 5, 20),
 BirdieOrBetterShots: (1, 5, 20),
 ParOrBetterShots: (4, 20, 40),
 MultiPlayerCoursesCompleted: (3, 10, 30),
 CourseZeroWins: (1, 5, 10),
 CourseOneWins: (1, 5, 10),
