...
QuestsItemDict = {1: ['Pair of Glasses', 'Pairs of Glasses', 'a '],
 ...
 4011: ["Leo's Lyrics", "Leo's LFAyrics", ''],
...
SillyPhase3Chatter = ['The Cogs hate how silly Toontown Journey is becoming!',
...
LauncherConnectProxyAttempt = 'Connecting to Toontown Journey: %s (proxy: %s) attempt: %s'
...
TutorialBook1 = 'The book contains lots of useful information like this map of Toontown Journey.'
...
WaiterInvasionBulletin3 = lToonHQ + ": The unemployed waiters are invading Toontown Journey!!!"
...
QuestScriptTutorialMickey_1 = 'Toontown Journey has a new citizen! Do you have some extra gags?'
...
QuestScriptTutorialMinnie_1 = 'Toontown Journey has a new citizen! Do you have some extra gags?'
QuestScriptTutorialMinnie_2 = 'Sure, %s!'
QuestScriptTutorialMinnie_3 = 'Tutorial Tom will tell you all about the Cogs.\x07Gotta go!'
QuestScript101_1 = 'These are Cogs. They are robots that are trying to take over Toontown Journey.'
