...
ProductPrefix = "TT"
MoreOptionsPageTitle = "MoreOptions"
Mickey = "Mickey"
...
QuestDialogDict = {
    ...
    164: {
        QUEST: "You look like you could use some new gags.\x07Go see %s, maybe he can help you out._where_"
        % Flippy
    },
    165: {
    ...
    1041: {
        QUEST: "Hi!  What brings you here?\x07Everybody uses their portable hole to travel around Toontown.\x07Why, you can teleport to your friends using the Friends List, or to any neighborhood using the map in the Shticker Book.\x07Of course, you have to earn that!\x07Say, I can turn on your teleport access to "
        + lToontownCentral
    ...
    1045: {
        ...
        LEAVING: "",
        COMPLETE: "Ah, yes, says here you have been a great help to some of the fine folks out on Loopy Lane.\x07Says you need teleport access to "
        + lToontownCentral
    ...
    1055: {
        QUEST: "Yowza!  I can't find the tires to this here clown car anywhere!\x07Do ya think you could help me out?\x07I think Loopy Bob may have tossed them in the pond in the "
        + lToontownCentral
    ...
    1061: {
        QUEST: "Great - thanks for the ink!\x07You know what, maybe if you cleared away some of those Pencil Pushers...\x07I wouldn't run out of ink again so quickly.\x07Defeat 6 Pencil Pushers in "
        + lToontownCentral
        + " for your reward.",
        LEAVING: "",
    ...
    1062: {
        QUEST: "Great - thanks for the ink!\x07You know what, maybe if you cleared away some of those Bloodsuckers...\x07I wouldn't run out of ink again so quickly.\x07Defeat 6 Bloodsuckers in "
        + lToontownCentral
        + " for your reward.",
        LEAVING: "",
        COMPLETE: "Thanks!  Let me reward you for your help.",
    ...
    1068: {
        QUEST: "I wasn't expecting a package.  Maybe it's for Dr. I.M. Euphoric?\x07My assistant was going over there today anyway, so I'll have him check for you.\x07In the meantime, would you mind getting rid of some of the Cogs on my street?\x07Defeat 10 Cogs in "
        + lToontownCentral
        + ".",
        LEAVING: "",
    ...
    2212: {
        QUEST: "A deal's a deal.\x07Here's your ballast for that cheapskate Melville._where_",
    ...
    3208: {
        QUEST: "We've been getting complaints from the residents lately about all of the Cold Callers.\x07See if you can defeat 10 Cold Callers to help out your fellow Toons in "
        + lDaisyGardens
        + "."
    },
    3209: {
        QUEST: "Thanks for taking care of those Cold Callers!\x07But now the Telemarketers have gotten out of hand.\x07Defeat 10 Telemarketers in "
        + lDaisyGardens
        + " and come back here for your reward."
    },
    3247: {
        QUEST: "We've been getting complaints from the residents lately about all of the Bloodsuckers.\x07See if you can defeat 20 Bloodsuckers to help out your fellow Toons in "
        + lDaisyGardens
        + "."
    },
    3210: {
        QUEST: "Oh no, The Squirting Flower on Maple Street just ran out of flowers!\x07Take them ten of your own squirting flowers to help out.\x07Make sure you have 10 squirting flowers in your inventory first.",
        LEAVING: "",
    ...
    3221: {
        QUEST: "Hi, _avName_! There you are!\x07I heard you were quite an expert in squirt attacks.\x07I need someone to set a good example for all the Toons in "
        + lDaisyGardens
    ...
    3235: {
        QUEST: "Oh, this is the salad I ordered!\x07Thank you for bringing it to me.\x07All those Cogs must have frightened away _toNpcName_'s regular delivery person again.\x07Why don't you do us a favor and defeat some of the Cogs out there?\x07Defeat 10 Cogs in "
        + lDaisyGardens
        + " and then report back to _toNpcName_.",
    ...
    3238: {
        QUEST: 'Oh no! A "Mingler" Cog has stolen the Key to '
        + lDaisyGardens
        + "!\x07See if you can recover it.\x07Remember, The Mingler can be found only inside Sellbot buildings."
    },
    3239: {
        QUEST: "You found a key all right, but it isn't the right one!\x07We need the Key to "
        + lDaisyGardens
        + '.\x07Keep looking! A "Mingler" Cog still has it!'
    },
    3242: {
        QUEST: "Oh no! A Legal Eagle Cog has stolen the Key to "
        + lDaisyGardens
    ...
    3243: {
        QUEST: "You found a key all right, but it isn't the right one!\x07We need the Key to "
        + lDaisyGardens
        + ".\x07Keep looking! A Legal Eagle Cog still has it!"
    },
    3240: {
    ...
    3250: {
        QUEST: "Detective Lima over on Oak Street has heard some reports of a Sellbot Headquarters.\x07Head over there and help her investigate."
    },
    3251: {
    ...
    902: {
        QUEST: "Go see Leo.\x07He needs someone to deliver a message for him._where_"
    },
    4903: {
    ...
    4904: {
        QUEST: "Jes, I tink I can polish dees.\x07But I need soma de blue ink from de squid.",
        GREETING: "Hola!",
        LEAVING: "Adios!",
    ...
    4910: {
        QUEST: "All done!\x07Sorry it took so long.\x07Take this back to Leo._where_",
        GREETING: "",
    ...
    5216: {
        QUEST: "We told you we would helps you.\x07So take this ring to the girl.",
        GREETING: "",
        LEAVING: "",
    ...
    5223: {
        QUEST: "Okay.  Thanks, hon.\x07Here, now take this to Harry.  It should calm him right down.",
        GREETING: "",
        LEAVING: "",
    ...
    5231: {
        QUEST: "Great, that's the tooth alrighty!\x07Why don't you just run it over to Phil for me?",
        GREETING: "",
        LEAVING: "",
    ...
    5239: {
        QUEST: "Thanks for bringing back my ice cream cones!\x07Here's one for Lil Oldman.",
        GREETING: "",
        LEAVING: "",
    ...
    11001: {
        ...
        INCOMPLETE_PROGRESS: "Have you tried looking on %s?"
        % GlobalStreetNames[2100][-1],
    ...
    11003: {
        ...
        INCOMPLETE_PROGRESS: "You are looking on %s, right?"
        % GlobalStreetNames[2200][-1],
    ...
    11005: {
        ...
        INCOMPLETE_PROGRESS: "Are you sure you're looking on %s?"
        % GlobalStreetNames[2300][-1],
    ...
    11009: {
        GREETING: "",
        LEAVING: "",
        QUEST: "Fancy seeing you here!\x07Now I need readings on %s."
    ...
    11012: {GREETING: "", LEAVING: "", QUEST: "You know the drill._where_"},
    11013: {
        GREETING: "",
        LEAVING: "",
    ...
    11022: {GREETING: "", LEAVING: "", QUEST: "I hate to say it, but..._where_"},
    11023: {
        GREETING: "",
        LEAVING: "",
    ...
    11025: {
        GREETING: "",
        LEAVING: "",
        QUEST: "I believe we still need a reading from %s."
    ...
    11027: {
        GREETING: "",
        LEAVING: "",
        QUEST: "Back so soon?\x07The final reading is on %s."
    ...
    12006: {GREETING: "", LEAVING: "", QUEST: "_toNpcName_ has more parts for you..."},
    12007: {
        GREETING: "",
        LEAVING: "",
    ...
    12008: {GREETING: "", LEAVING: "", QUEST: "Head on over to..._where_"},
    12009: {
        GREETING: "",
        LEAVING: "",
        QUEST: "I'm after a Downsizer now...",
        INCOMPLETE_PROGRESS: "Having trouble? Try looking on %s"
        % GlobalStreetNames[3100][-1],
    ...
    12012: {GREETING: "", LEAVING: "", QUEST: "_toNpcName_ needs more Bossbots."},
    12013: {
        GREETING: "",
        LEAVING: "",
    ...
    12016: {GREETING: "", LEAVING: "", QUEST: "_toNpcName_ was looking for you..."},
    12017: {
        GREETING: "",
        LEAVING: "",
    ...
    12018: {GREETING: "", LEAVING: "", QUEST: "Could you swing by..._where_"},
    12019: {
        GREETING: "",
        LEAVING: "",
    ...
    12022: {GREETING: "", LEAVING: "", QUEST: "You know..._where_"},
    12023: {
        GREETING: "",
        LEAVING: "",
    ...
    12026: {GREETING: "", LEAVING: "", QUEST: "Please go see _toNpcName_ again."},
    12027: {
        GREETING: "",
        LEAVING: "",
...
ReportPanelBody = 'This feature will send a complete report to a Toontown Journey Moderator. Instead of sending a report, you might choose to do one of the following:\n\n  - Teleport to another district\n  - Use "Ignore" on the toon\'s panel\n\nDo you really want to report %s to a Toontown Journey Moderator?'
...
ReportPanelCategoryBody = "You are about to report %s. A Toontown Journey Moderator will be alerted to your complaint and will take appropriate action for anyone breaking our rules. Please choose the reason you are reporting %s:"
...
ReportPanelConfirmations = (
    ...
    "You are about to report that %s has created a name that does not follow the Toontown Journey rules.",
    "You are about to report that %s has hacked/tampered with the game or used third party software.",
)
ReportPanelWarning = "We take reporting very seriously. Your report will be viewed by a Toontown Journey Moderator who will take appropriate action for anyone breaking our rules. If your account is found to have participated in breaking the rules, or if you make false reports or abuse the 'Report a Player' system, a Moderator may take action against your account. Are you absolutely sure you want to report this player?"
ReportPanelThanks = "Thank you! Your report has been sent to a Toontown Journey Moderator for review. There is no need to contact us again about the issue. The moderation team will take appropriate action for a player found breaking our rules."
ReportPanelRemovedFriend = (
    "We have automatically removed %s from your Toon Friends List."
)
ReportPanelRemovedPlayerFriend = "We have automatically removed %s as a Player friend so as such you will not see them as your friend in any Toontown Journey product."
ReportPanelAlreadyReported = "You have already reported %s during this session. A Toontown Journey Moderator will review your previous report."
...
SuitAttackTaunts = {
    ...
    "Legalese": [
        ...
        "The opinions expressed in this attack are not those of Toontown Journey.",
...
SillyPhase3Chatter = [
    "The Cogs hate how silly Toontown Journey is becoming!",
...
SillyPhase4Chatter = [
    ...
    "Enjoy the sillier Toontown Journey!",
]
...
FriendInviterToonFriendInfo = "A friend only in Toontown Journey"
FriendInviterPlayerFriendInfo = "A friend across the Toontown Journey network"
...
LauncherStartingMessage = "Starting Toontown Journey... "
...
LauncherConnectProxyAttempt = (
    "Connecting to Toontown Journey: %s (proxy: %s) attempt: %s"
)
LauncherConnectAttempt = "Connecting to Toontown Journey: %s attempt %s"
LauncherDownloadServerFileList = "Updating Toontown Journey..."
LauncherCreatingDownloadDb = "Updating Toontown Journey..."
LauncherDownloadClientFileList = "Updating Toontown Journey..."
LauncherFinishedDownloadDb = "Updating Toontown Journey... "
LauncherStartingGame = "Starting Toontown Journey..."
LauncherRecoverFiles = "Updating Toontown Journey. Recovering files..."
LauncherCheckUpdates = "Checking for updates for " + LauncherProgress
LauncherVerifyPhase = "Updating Toontown Journey..."
...
EventsPageNewsPaperTitle = "TOONTOWN Journey TIMES"
...
PartyPlannerTTTimeText = "Toontown Journey Time"
...
MusicTtiTheme = "The Toontown Journey Theme"
MusicTtTheme = "The Toontown Journey Theme"
...
MusicMgTarget = "Soarin' Over Toontown Journey"
...
OptionsPageExitToontown = "Exit Toontown Journey"
...
OptionsPageExitConfirm = "Exit Toontown Journey?"
DisplaySettingsTitle = "Display Settings"
DisplaySettingsIntro = "The following settings are used to configure the way Toontown Journey is displayed on your computer.  It is usually unnecessary to adjust these unless you are experiencing a problem."
...
CdrPageTitle = "Enter a Toontown Journey Code"
...
TutorialMickeyWelcome = "Welcome to Toontown Journey!"
...
TutorialBook1 = (
    "The book contains lots of useful information like this map of Toontown Journey."
)
...
MakeAToonLastStep = "Last step before going to Toontown Journey!"
...
SkelecogInvasionBegin1 = (
    lToonHQ + ": Hmm... We're getting a strange reading over here..."
)
SkelecogInvasionBegin2 = (
    lToonHQ + ": The Cog factories are running out of parts to build new Cogs!"
)
...
SkelecogInvasionBulletin2 = (
    lToonHQ + ": The Cog factories are running out of parts to build new Cogs!"
)
SkelecogInvasionBulletin3 = lToonHQ + ": Skelecogs have taken over Toontown!!!"
WaiterInvasionBegin1 = (
    lToonHQ + ": It appears that the C.E.O. has fired all his waiters..."
)
...
WaiterInvasionBulletin3 = (
    lToonHQ + ": The unemployed waiters are invading Toontown Journey!!!"
)
V2InvasionBegin1 = lToonHQ + ": Yikes!!! This isn't good, Toons!"
V2InvasionBegin2 = (
    lToonHQ + ": A major firmware update has been released to the Cogs!!!"
)
V2InvasionBegin3 = lToonHQ + ": Version 2.0 Cogs have taken over Toontown Journey!!!"
...
V2InvasionBulletin3 = lToonHQ + ": Version 2.0 Cogs have taken over Toontown Journey!!!"
LeaderboardTitle = "Toon Platoon"
QuestScriptTutorialMickey_1 = (
    "Toontown Journey has a new citizen! Do you have some extra gags?"
)
QuestScriptTutorialMickey_2 = "Sure, %s!"
QuestScriptTutorialMickey_3 = (
    "Tutorial Tom will tell you all about the Cogs.\x07Gotta go!"
)
QuestScriptTutorialMickey_4 = "Hello, new citizen! Welcome to Toontown Journey! Come over here so I can tell you what's been going on in town recently. Use the arrow keys to move."
QuestScriptTutorialMinnie_1 = (
    "Toontown Journey has a new citizen! Do you have some extra gags?"
)
QuestScriptTutorialMinnie_2 = "Sure, %s!"
QuestScriptTutorialMinnie_3 = (
    "Tutorial Tom will tell you all about the Cogs.\x07Gotta go!"
)
QuestScript101_1 = (
    "These are Cogs. They are robots that are trying to take over Toontown Journey."
)
...
QuestScriptTutorialBlocker_7 = "It's called the SpeedChat Plus button. You need to turn on Speedchat Plus in your Account Manager on the Toontown Journey Website to use it."
...
QuestScript140_1 = (
    "Good job finding the trolley!\x07By the way, I have this friend, Librarian Larry, who is quite a book worm.\x07I picked this book up for him last time I was over in "
    + lDonaldsDock
    + ".\x07Could you take it over to him, he is usually in the Library."
)
...
BrutalBossCogPromoteDoobers = (
    "Welcome back.  It seems the V.P. made a wise decision promoting you."
)
...
BrutalBossCogWelcomeToons = (
    "Oh, look what we have here... I've been expecting you, Toons"
)
...
BrutalCashbotBossOuttaHere = (
    "Looks like we'll have to remanufacture the C.F.O!  I'm out of here!"
)
...
BrutalCashbotBossDiscoverToons2 = (
    "Well, well, well...  Look who we have here!  You Toons don't give up, do you?"
)
ResistanceToonKeepHimBusy = "Keep him busy!  I'm going to set a trap!"
BrutalResistanceToonKeepHimBusy = (
    "Keep him busy while I get these cranes operating again!"
)
...
BrutalResistanceToonCraneInstructions3 = (
    "Grab a goon with a magnet and hit the C.E.O. right in the head."
)
...
CatalogPurchaseGiftItemAvailable = (
    "Excellent!  %s can start using your gift right away."
)
...
NPCToonNames = {
    ...
    2018: "Doctor Durko",
    2019: "Doctor Snow",
    2020: "Professor Zilly",
    2021: "redfire",
    2022: "Buster",
    2023: "Head Ranger Comet",
    2024: "Moderator Jinx",
    2101: "Dentist Daniel",
    2102: "Sheriff Sherry",
    2103: "Sneezy Kitty",
...
FireworksNewYearsEveBeginning = (
    lToonHQ + ": Happy New Year! Enjoy the fireworks show, sponsored by Flippy!"
)
FireworksNewYearsEveEnding = (
    lToonHQ + ": Hope you enjoyed the show! Have a Toontastic New Year!"
)
...
TipDict = {
    ...
    TIP_GENERAL: (
        ...
        'Press the "F9" key to take a screenshot, which will be saved in your Toontown Journey folder on your computer.',
        ...
        "You never need to save your Toontown progress. The Toontown Journey servers continually save all the necessary information.",
...
FishSpeciesNames = {
    ...
    34: ("Devil Ray",),
    35: ("Sword Fish", "Atlantic Sword Fish", "Arctic Sword Fish",),
    36: (
        "Metal Fish",
        "Metal Bronze Fish",
        "Metal Gold Fish",
...
BoardingGroupsToLarge = (
    "%s is already in a different Boarding Group that is too large to merge."
)
...
buffIdStrings = {
    0: (
        "Your movement speed will be slightly increased for the next %d %s.",
        "Reward: Increased movement speed",
    ),
    1: (
        "Your gag accuracy will be slightly increased for the next %d %s.",
        "Reward: Increased gag accuracy",
    ),
    2: (
        "Your gag experience will be slightly increased for the next %d %s.",
...
houseNames = {
    HouseGlobals.HOUSE_DEFAULT: "Classic TTJ House",
    HouseGlobals.HOUSE_CABIN: "TTJ Beta House",
}
