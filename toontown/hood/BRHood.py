...
class BRHood(ToonHood):
    ...
    HOLIDAY_DNA = {
      ToontownGlobals.WINTER_DECORATIONS: ['phase_8/dna/winter_storage_BR.dna'],
      ToontownGlobals.WACKY_WINTER_DECORATIONS: ['phase_8/dna/winter_storage_BR.dna'],
      ToontownGlobals.HALLOWEEN_PROPS: ['phase_8/dna/halloween_props_storage_BR.dna'],
      ToontownGlobals.SPOOKY_PROPS: ['phase_8/dna/halloween_props_storage_BR.dna']}
