...
NPCToonDict = {
    ...
    20002: (-1, TTLocalizer.TutorialHQOfficerName, ('dls', 'ms', 'm', 'm', 6, 0, 6, 6, 0, 10, 0, 10, 2, 9), 'm', 1,
            NPC_SPECIALQUESTGIVER),
    2002: (2514, lnames[2002], ('hss', 'ls', 'l', 'm', 4, 0, 4, 4, 0, 3, 0, 3, 1, 18), 'm', 1, NPC_BANKER),
    ...
    2018: (2513, lnames[2018], ('css', 'ls', 'm', 'm', 20, 41, 20, 20, 18, 2, 12, 2, 0, 17), 'm', 1, NPC_SCIENTIST),
    2019: (2513, lnames[2019], ('dss', 'md', 's', 'f', 8, 8, 8, 8, 45, 24, 3, 24, 8, 2), 'f', 1, NPC_SCIENTIST),
    2020: (2513, lnames[2020], ('mss', 'ms', 'm', 'm', 20, 20, 20, 20, 111, 27, 98, 27, 41, 27), 'm', 1, NPC_SCIENTIST),
    2023: (-1, lnames[2023], ('dss', 'ms', 'm', 'm', 20, 20, 20, 20, 111, 27, 98, 27, 41, 27), 'm', 1, NPC_REGULAR),
    2024: (-1, lnames[2024], ('css', 'md', 'm', 'f', 43, 25, 47, 43, 45, 32, 34, 32, 59, 29), 'f', 1, NPC_REGULAR),
    ...
    1014: (
    1000, lnames[1014], ('mss', 'ms', 's', 'm', 20, 20, 20, 20, 123, 27, 110, 27, 50, 27), 'm', 1, NPC_PARTYPERSON),
    1015: (
    1000, lnames[1015], ('css', 'ms', 'm', 'm', 25, 18, 25, 25, 111, 27, 98, 27, 41, 27), 'm', 1, NPC_PARTYPERSON),
    ...
    6001: (6001, lnames[5005], ('mls', 'md', 's', 'f', 6, 0, 6, 6, 0, 21, 0, 21, 2, 3), 'f', 0, NPC_CLERK),
    6002: (6001, lnames[5006], ('hsl', 'ms', 's', 'm', 20, 0, 20, 20, 0, 9, 0, 9, 0, 1), 'm', 0, NPC_CLERK),
    ...
    91913: (2000, lnames[91913], 'r', 'm', 1, NPC_SMART),
    # Magic Cat SOS
    # 5 Stars, Heal SOS, jugggle 145 Health. "The Heaven Healer".
    ...
    91921: (-1, lnames[91920], ('mss', 'm', 'm', 'm', 15,0,15,15, 148, 27, 136, 27, 57, 27 ), 'm', 0, NPC_REGULAR)}

if config.GetBool('want-new-toonhall', 1):
    NPCToonDict[2001] = (
        2513, lnames[2001], ('dss', 'ms', 'm', 'm', 17, 0, 17, 17, 3, 3, 3, 3, 7, 2), 'm', 1, NPC_FLIPPYTOONHALL)
else:
    NPCToonDict[2001] = (
        2513, lnames[2001], ('dss', 'ms', 'm', 'm', 17, 0, 17, 17, 3, 3, 3, 3, 7, 2), 'm', 1, NPC_REGULAR)
del lnames
...
HQnpcFriends = {2001: (ToontownBattleGlobals.HEAL_TRACK, 5, ToontownGlobals.MaxHpLimit, 5),
                2018: (ToontownBattleGlobals.HEAL_TRACK, 5, 145, 5),
                2132: (ToontownBattleGlobals.HEAL_TRACK, 5, 70, 4),
                2121: (ToontownBattleGlobals.HEAL_TRACK, 5, 45, 3),
                91917: (ToontownBattleGlobals.HEAL_TRACK, 5, 145, 5),
                1014: (ToontownBattleGlobals.TRAP_TRACK, 6, 255, 5),
                2011: (ToontownBattleGlobals.TRAP_TRACK, 4, 180, 5),
                2019: (ToontownBattleGlobals.TRAP_TRACK, 6, 200, 5),
                2024: (ToontownBattleGlobals.TRAP_TRACK, 6, 200, 5),
                3007: (ToontownBattleGlobals.TRAP_TRACK, 4, 70, 4),
                1001: (ToontownBattleGlobals.TRAP_TRACK, 4, 50, 3),
                2020: (ToontownBattleGlobals.LURE_TRACK, 5, 0, 5),
                ...
                1015: (ToontownBattleGlobals.SOUND_TRACK, 6, 255, 5),
                2023: (ToontownBattleGlobals.SOUND_TRACK, 1, 200, 5),
                4119: (ToontownBattleGlobals.SOUND_TRACK, 5, 80, 5),
                91918: (ToontownBattleGlobals.SOUND_TRACK, 6, 1, 0),
...
def npcFriendsMinMaxStars(minStars, maxStars):
    return [id for id in list(npcFriends.keys()) if
            getNPCTrackLevelHpRarity(id)[3] >= minStars and getNPCTrackLevelHpRarity(id)[3] <= maxStars]
