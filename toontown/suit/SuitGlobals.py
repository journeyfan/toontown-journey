...
suitProperties = {'f': (4.0 / cSize, SuitDNA.corpPolyColor, ['flunky', 'glasses'], '', 4.88),
                  ...
                  'tm2': (7.0 / aSize, VBase4(0.75, 0.95, 0.75, 1.0), ['themolder'], '', 9.34),
                  # Lawbots
                  ...
                  #Secbots
                  'wm': (4.125 / aSize, SuitDNA.corpPolyColor, ['yesman'], 'watchman.jpg', 5.28),
                  ...
                  'ssa': (5.3/ cSize, SuitDNA.securityPolyColor, ['moneybags'], '', 6.97),
                  'w': (7.0 / aSize, SuitDNA.securityPolyColor, ['yesman'], 'warden.jpg', 8.95),
                  }
