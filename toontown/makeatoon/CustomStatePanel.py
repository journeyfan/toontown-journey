...
class CustomStatePanel(DirectFrame):
    ...
    def __init__(self):
        ...
        DirectFrame.__init__(self, relief=None, image=background, image_scale=(1.5, 1, 1.45), frameSize=(0.4, -1.2, 0.8, -0.8), image_pos=(-0.39,0,0.075))
    ...
    def createGagScreen(self):
        ...
        self.__nextButton = DirectButton(parent=self, text_scale=.075, text=T_NEXT, pos=(-.4, 0, -.58), relief=None, text_font=self._font, 
