...
SuitAttributes = {'f': {'name': TTLocalizer.SuitFlunky, 'singularname': TTLocalizer.SuitFlunkyS, 
   ...
   'tbc': {'name': TTLocalizer.SuitTheBigCheese, 'singularname': TTLocalizer.SuitTheBigCheeseS, 
    ...
    'tm2': {'name': TTLocalizer.SuitTheMolder, 'singularname': TTLocalizer.SuitTheMolderS,
    'pluralname': TTLocalizer.SuitTheMolderP,
    'level': 12,
    'def': (60, 65, 70, 70, 70, 70, 70, 70),
    'freq': (5, 5, 5, 5, 5, 5, 5),
    'acc':  (60, 65, 70, 75, 80, 85, 90, 95),
    'attacks': (
                     (
                      'CigarSmoke',
                     ...
                     (
                      'SongAndDance',
                      (22, 24, 26, 28, 30, 32, 34, 36),
                      (80, 85, 90, 95, 95, 95, 95, 95),
                      (20, 20, 20, 20, 20, 20, 20, 20)),
                     (
                      'TeeOff',
                      (20, 22, 24, 26, 28, 30, 32, 35, 38),
                      (80, 85, 90, 95, 95, 95, 95, 95, 95),
