...
FishAudioFileDict = {
    ...
    35: ("Sword_Fish.ogg", 1, 0, 1.23),
    36: ("Metal_Fish.ogg", 1, 0, 1.0),
}
FishFileDict = {
    -1: (
        4,
...
__fishDict = {
    ...
    2: (
        (2, 6, 1, (TTG.DaisyGardens, Anywhere)),
        (2, 6, 8, (TTG.ElmStreet, TTG.DaisyGardens)),
        (5, 11, 4, (TTG.LullabyLane,)),
        (2, 6, 3, (TTG.DaisyGardens, TTG.MyEstate)),
        (5, 11, 2, (TTG.DonaldsDreamland, TTG.MyEstate)),
    ),
    4: (
        (2, 8, 1, (TTG.ToontownCentral, Anywhere)),
    ...
    8: (
        ...
        (1, 5, 8, (TTG.MyEstate, Anywhere)),
    ),
    10: ((6, 10, 9, (TTG.MyEstate, Anywhere)),),
    12: (
        (7, 15, 1, (TTG.DonaldsDock, Anywhere)),
    ...
    14: (
        (2, 6, 1, (TTG.DaisyGardens, TTG.MyEstate, Anywhere)),
        (2, 6, 3, (TTG.DaisyGardens, TTG.MyEstate)),
    ),
    16: (
        (4, 12, 5, (TTG.MinniesMelodyland, Anywhere)),
        (4, 12, 7, (TTG.BaritoneBoulevard, TTG.MinniesMelodyland)),
        (4, 12, 8, (TTG.TenorTerrace, TTG.MinniesMelodyland)),
    ),
    18: (
        (2, 4, 3, (TTG.DonaldsDock, Anywhere)),
        (5, 8, 7, (TTG.TheBrrrgh,)),
        (4, 6, 8, (TTG.LighthouseLane,)),
    ),
    20: (
        (4, 6, 1, (TTG.DonaldsDreamland,)),
        (14, 18, 8, (TTG.DonaldsDreamland,)),
    ...
    22: (
        (12, 16, 2, (TTG.MyEstate, TTG.DaisyGardens, Anywhere)),
    ...
    26: (
        ...
        (16, 20, 8, (TTG.WalrusWay, TTG.TheBrrrgh)),
    ),
    28: (
        (2, 10, 2, (TTG.DonaldsDock, Anywhere)),
        (4, 10, 6, (TTG.BarnacleBoulevard, TTG.DonaldsDock)),
        (4, 10, 7, (TTG.SeaweedStreet, TTG.DonaldsDock)),
    ),
    30: (
        (13, 17, 5, (TTG.MinniesMelodyland, Anywhere)),
        (16, 20, 8, (TTG.AltoAvenue, TTG.MinniesMelodyland)),
        (12, 18, 8, (TTG.TenorTerrace, TTG.MinniesMelodyland)),
        (12, 18, 6, (TTG.MinniesMelodyland,)),
        (12, 18, 7, (TTG.MinniesMelodyland,)),
    ),
    32: (
        (1, 5, 2, (TTG.ToontownCentral, TTG.MyEstate, Anywhere)),
        (1, 5, 3, (TTG.TheBrrrgh, TTG.MyEstate, Anywhere)),
        (1, 5, 4, (TTG.DaisyGardens, TTG.MyEstate)),
        (1, 5, 5, (TTG.DonaldsDreamland, TTG.MyEstate)),
        (1, 5, 8, (TTG.TheBrrrgh, TTG.DonaldsDreamland)),
    ),
